  ...
  return (
    <div className="flex flex-col justify-center mt-[-12rem] sm:mt-[-8rem]">
      <GlowLamp color="40,87,255" colorDark="48,58,117">
        ...
        >
          <div
            className={`${styles.innerWidth} mx-auto ${styles.flexCenter} mb-[-1rem] lg:mb-[0rem] flex-col`}
          >
          ...
          <div
            className={`${styles.xPaddings} mt-[1.5rem] mini:mt-[3rem] lg:mt-[2rem] flex projects_lg:flex-row flex-col min-h-[70vh] md:min-h-[60vh] lg:min-h-[50vh] gap-5 z-20`}
          >
