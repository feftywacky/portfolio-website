...
const About = () => (
  <div className={`flex flex-col justify-center mt-[-10rem] sm:mt-[-9rem]`} >
    <GlowLamp color='0,225,244' colorDark='23,70,81'>
      ...
      >
        ...
        <motion.p
          ...
          className={`px-[3.5rem] sm:px-[10rem] mt-[1rem] sm:mt-[2rem] font-normal md:text-[24px] mini:text-[16px] text-[14px] text-left text-white z-10`}
        >
          ...
          reading, going to the gym, or listening music (please recommend me new songs!).
          <br />
          <br />
